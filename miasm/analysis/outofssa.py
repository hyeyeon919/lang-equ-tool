...
class UnSSADiGraph(object):
    ...
    def ssa_def_is_live_at(self, node_a, node_b, parent):
        ...
        If @parent is None, this is a liveness test_c for a post phi variable;
        Else, it is a liveness test_c for a variable source of the phi node
    ...
    def merge_sets_interfere(self, merge_a, merge_b, parent):
        ...
        while merge_a_list or merge_b_list:
            ...
            # Don't test_c node in same merge_set
            if (
                    # Is stack not empty?
                    dom and
                    ...
                    # Actually test_c for interference
